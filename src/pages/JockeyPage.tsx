...
export default function JockeyPage() {
  ...
  const handleAcceptInvitation = (id: string) => {
    ...
    addToast(
      `Response recorded successfully! Tentatively registered to ride ${target?.horseId}. Awaiting final Owner confirmation.`,
      "success"
    );
  };
  ...
  const handleDeclineInvitation = (id: string) => {
    ...
    addToast(
      `You declined the invitation to ride ${target?.horseId}. Deep access revoked.`,
      "info"
    );
  };
