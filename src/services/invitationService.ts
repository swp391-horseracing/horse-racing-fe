export type InvStatus = "Pending" | "Accepted" | "Declined" | "Expired" | "Cancelled" | "Superseded";
...
export const InvitationService = {
    ...
    updateInvitationStatus: async (id: number, status: InvStatus): Promise<Invitation | undefined> => {
