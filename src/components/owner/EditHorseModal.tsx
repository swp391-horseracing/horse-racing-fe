...
export function EditHorseModal({
  isOpen,
  onClose,
  onSubmit,
  initialData,
      ...
      <div className="bg-white rounded-2xl border border-slate-100 max-w-lg w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 my-8">
        ...
        <div className="bg-gradient-to-r from-[#064E3B] to-[#0b634c] p-6 text-white relative">
          ...
          <p className="text-xs text-emerald-100/80 mt-1">
            Update pedigree details for your horse.
          </p>
        </div>

        {/* Form Body */}
        <form onSubmit={onSubmit} className="p-6 space-y-4">
          <input type="hidden" name="horseId" value={initialData.id} />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                name="birth_date"
                type="date"
                defaultValue={initialData.birthDate?.split("T")[0]}
            ...
            <div className="space-y-1.5">
              ...
              <select
                required
                name="health_status"
                defaultValue={initialData.healthStatus}
                className="w-full bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 focus:border-[#064E3B] rounded-xl px-3 py-2.5 text-xs font-medium outline-none transition"
              >
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                max="100"
                step="1"
                defaultValue={initialData.baseSpeed}
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                max="100"
                step="1"
                defaultValue={initialData.stamina}
                placeholder="0-100 (optional)"
                className="w-full bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 focus:border-[#064E3B] rounded-xl px-3 py-2.5 text-xs font-medium outline-none transition"
              />
            </div>
