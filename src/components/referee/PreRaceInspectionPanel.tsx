              ...
              {lane.inspectionStatus === "pending" && (
                <div className="flex gap-2 mt-3">
                  <button
                    ...
                    className="flex-1 text-[10px] font-bold bg-emerald-600 text-white px-2 py-1.5 rounded-lg hover:bg-emerald-700 transition flex items-center justify-center gap-1"
                  >
                  ...
                  <button
                    onClick={() => {
                      ...
                      setFailCategory(PRE_RACE_WITHDRAW_REASONS[0]);
                      setFailNotes("");
                    }}
                    className="flex-1 text-[10px] font-bold bg-red-700 text-white px-2 py-1.5 rounded-lg hover:bg-red-850 transition flex items-center justify-center gap-1"
                  >
